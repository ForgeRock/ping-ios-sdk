...
# Migrating from the ForgeRock SDK to the Ping SDK for iOS

This guide helps you transition from the legacy ForgeRock iOS SDK to the modern Ping SDK for iOS.
...
authentication), the Ping SDK provides dedicated migration modules that automatically transfer
