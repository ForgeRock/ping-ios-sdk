...
|------------|---------|-------------|
| `PingOrchestrate` | ~> 2.1.0-beta1 | Core orchestration framework |
| `PingJourneyPlugin` | ~> 2.1.0-beta1 | Journey-based authentication flow management |
| `PingCommons` | ~> 2.1.0-beta1 | Common utilities including JWT signing |
| `PingStorage` | ~> 2.1.0-beta1 | Secure storage capabilities |
| `PingLogger` | ~> 2.1.0-beta1 | Logging framework |
