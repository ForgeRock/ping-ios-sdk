...
|------------|---------|-------------|
| `PingOrchestrate` | ~> 2.1.1 | Core orchestration framework |
| `PingJourneyPlugin` | ~> 2.1.1 | Journey-based authentication flow management |
| `PingCommons` | ~> 2.1.1 | Common utilities including JWT signing |
| `PingStorage` | ~> 2.1.1 | Secure storage capabilities |
| `PingLogger` | ~> 2.1.1 | Logging framework |
