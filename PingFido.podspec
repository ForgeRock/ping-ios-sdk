...
Pod::Spec.new do |s|
  ...
  s.ios.dependency 'PingLogger', '~> 2.1.0-beta1'
  s.ios.dependency 'PingCommons', '~> 2.1.0-beta1'
  s.ios.dependency 'PingDavinciPlugin', '~> 2.1.0-beta1'
  s.ios.dependency 'PingJourneyPlugin', '~> 2.1.0-beta1'
end
