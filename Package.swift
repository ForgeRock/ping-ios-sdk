...
let package = Package (
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/google/GoogleSignIn-iOS.git", .upToNextMinor(from: "8.1.0-vwg-eap-1.0.0"))
    ],
    targets: [
        ...
        .target(name: "PingExternal-idp", dependencies: [.target(name: "PingDavinci"), .target(name: "PingBrowser"), .product(name: "FacebookLogin", package: "facebook-ios-sdk"), .product(name: "GoogleSignIn", package: "GoogleSignIn-iOS")], path: "External-idp/External-idp", exclude: ["ExtrernalIdp.h"], resources: [.copy("PrivacyInfo.xcprivacy")])
    ]
)
