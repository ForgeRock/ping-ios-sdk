...
let package = Package (
    ...
    targets: [
        ...
        .target(name: "PingBinding", dependencies: [.target(name: "PingMfaCommons"), .target(name: "PingJourney"), .target(name: "PingOidc")], path: "Binding/Binding", resources: [.copy("PrivacyInfo.xcprivacy")]),
    ]
)
