...
let package = Package (
    ...
    targets: [
        ...
        .target(name: "PingExternalIdP", dependencies: [.target(name: "PingJourney"), .target(name: "PingDavinci"), .target(name: "PingBrowser")], path: "ExternalIdP/ExternalIdP", exclude: ["ExtrernalIdP.h"], resources: [.copy("PrivacyInfo.xcprivacy")]),
