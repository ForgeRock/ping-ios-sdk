...
class JSONUtilsTests: XCTestCase {
    ...
    func testJSONStringifyWithValidDictionary() {
        ...
        let jsonString = JSONUtils.jsonStringify(value: testData)
    ...
    func testJSONStringifyWithPrettyPrint() {
        ...
        let jsonString = JSONUtils.jsonStringify(
            value: testData,
            prettyPrinted: true
        )
    ...
    func testJSONStringifyWithInvalidObject() {
        ...
        let jsonString = JSONUtils.jsonStringify(value: invalidObject)
    ...
    func testJSONStringifyWithEmptyDictionary() {
        ...
        let jsonString = JSONUtils.jsonStringify(value: emptyDict)
    ...
    func testJSONStringifyWithEmptyArray() {
        ...
        let jsonString = JSONUtils.jsonStringify(value: emptyArray)
